    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("JAAG Coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a JAAG Coin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About JAAG Coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about JAAG Coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for JAAG Coin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your JAAG Coin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified JAAG Coin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the JAAG Coin Core help message to get a list with possible JAAG Coin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("JAAG Coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to JAAG Coin network", "", count));
    } else {
...
{
    QString strTitle = tr("JAAG Coin Core"); // default title
    ...
    // Append title to "JAAG Coin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
