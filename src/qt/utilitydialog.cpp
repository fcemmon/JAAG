    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("JAAG Coin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About JAAG Coin Core"));
...
All the JAAG Coin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
For more info see <a href=\"https://jaagcoreproject.atlassian.net/wiki/display/DOC/PrivateSend\">https://jaagcoreproject.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("JAAG Coin Core is shutting down...") + "<br /><br />" +
