...
*
*   Why is this needed?
*   - In JAAG Coin Core some blocks are superblocks, which output much higher amounts of coins
...
{
    if(fLiteMode) return; // disable all JAAG Coin Core specific functionality
