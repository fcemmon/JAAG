...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total jaag coin balance of the wallet\n"
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized jaag coin balance of the wallet\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"jaagaddress\"\n"
            "\nReturn information about the given jaag coin address.\n"
            "\nArguments:\n"
            "1. \"jaagaddress\"     (string, required) The jaag coin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"jaagaddress\", (string) The jaag coin address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: JAAG Coin address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are jaag coin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) jaag coin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"jaagaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"jaagaddress\"  (string, required) The jaag coin address to use for the signature.\n"
