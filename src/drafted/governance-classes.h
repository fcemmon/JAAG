 ...
 *
 *   // network
 *   CJAAGNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.jaag.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CJAAGNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: JAAGNetwork
// //   -- signature requirements : Key1(User)
// class CJAAGNetworkVariable : public CGovernanceObject
// {
// private:
