...
JAAG Coin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as JAAG Coin Core, where everyone uses
...
pay attention to for reviewers of JAAG Coin Core code.

General JAAG Coin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: JAAG Coin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
