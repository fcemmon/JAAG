...
*Setup instructions for a Gitian build of JAAG Coin Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the JAAGCoin
...
- [Building JAAG Coin Core](#building-jaag-core)
...
Clone the git repositories for JAAG Coin Core and Gitian.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/jaagcoreproject/jaag
```
...
in the JAAG Coin Core repository under 'Fetch and build inputs' to install sources which require
...
To build JAAG Coin Core (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the JAAG Coin Core repository.
...
```bash
    ...
    From https://github.com/jaagcoreproject/jaag
...
BTCPATH=/some/root/path/jaag.git
SIGPATH=/some/root/path/jaag-detached-sigs.git
...
[jaag/gitian.sigs](https://github.com/jaagcoreproject/gitian.sigs/) repository, or if that's not possible to create a pull
request.
